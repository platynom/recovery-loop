...
The old one-at-a-time sensitivity used five seeds and the superseded three-day cap; it only showed that the three-day loss survived its broad perturbation groups. The corrected sensitivity uses UPI, the frozen 14-day cap, and all ten validation seeds. Every independent ±25% row remains positive in 10/10 seeds. The weakest row reduces the authored 0.82 salary-day recovery probability to 0.615 and still yields +₹911,807 mean paired net (range +₹727,826 to +₹1,027,412). The combined least-favourable-direction case also remains positive: +₹1,085,508, 10/10 seeds (range +₹1,027,087 to +₹1,171,469). No sign-changing perturbation was found inside ±25%.

This does **not** make the result empirical. The sensitivity reuses the validation seeds after the headline was known, and therefore is diagnostic rather than a second held-out confirmation. Several rows are inert because the calibrated cohorts contain 19,654 insufficient-funds and 346 technical events but zero mapped hard-decline events; the 12:9:5:2 hard-subtype assumptions are consequently untested by this cohort. Uniform month sampling, incident placement at evaluation time, and seeded-uniform outcome draws are structural choices without a meaningful scalar ±25% perturbation. The complete rule inventory, per-seed rows, and combined factors are in `data/evaluation/ground-truth-sensitivity-14d-validation.json`.
