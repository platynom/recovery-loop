...
export function applyRefusalGate(event, prediction, policy = {}) {
  ...
  if (declineDeviation >= maxDeclineDeviation) reasons.push(`Bank decline rate is ${declineDeviation.toFixed(2)}x its ${(baseline * 100).toFixed(2)}% baseline (limit ${maxDeclineDeviation.toFixed(2)}x)`);
